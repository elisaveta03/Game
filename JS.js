function myfunc() {
    ...
    b1 = document.getElementsById("b1").value;
    b2 = document.getElementsById("b2").value;
    b3 = document.getElementsById("b3").value;
    b4 = document.getElementsById("b4").value;
    b5 = document.getElementsById("b5").value;
    b6 = document.getElementsById("b6").value;
    b7 = document.getElementsById("b7").value;
    b8 = document.getElementsById("b8").value;
    b9 = document.getElementsById("b9").value;
}
...
function reset () {
    location.reload();
    document.getElementsById("b1").value = '';
    document.getElementsById("b2").value = '';
    document.getElementsById("b3").value = '';
    document.getElementsById("b4").value = '';
    document.getElementsById("b5").value = '';
    document.getElementsById("b6").value = '';
    document.getElementsById("b7").value = '';
    document.getElementsById("b8").value = '';
    document.getElementsById("b9").value = '';
}
